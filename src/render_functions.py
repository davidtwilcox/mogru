...
def render_names_at_location(console: Console, x: int, y: int, engine: Engine) -> None:
    mouse_x, mouse_y = engine.mouse_location

    names_at_mouse_location: str = get_names_at_location(x=mouse_x, y=mouse_y, game_map=engine.game_map)
